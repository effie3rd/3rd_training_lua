...
local pose = {
   "menu_standing", "menu_crouching", "menu_jump_forward", "menu_jump_neutral", "menu_jump_back", "menu_sjump_forward",
   "menu_sjump_neutral", "menu_sjump_back"
}
...
local move_selection_type = {
   "menu_none", "menu_normal_attack", "menu_special_sa", "menu_option_select", "menu_recording"
}
...
local life_mode = {
   "menu_off", "menu_gauge_reset_value", "menu_gauge_reset_zero", "menu_gauge_reset_max", "menu_gauge_infinite"
}

local stun_mode = {
   "menu_off", "menu_gauge_reset_value", "menu_gauge_reset_zero", "menu_gauge_reset_max", "menu_gauge_always_zero",
   "menu_gauge_always_max"
}
...
local slot_replay_mode = {
   "menu_replay_normal", "menu_replay_random", "menu_replay_ordered", "menu_replay_repeat", "menu_replay_repeat_random",
   "menu_replay_repeat_ordered"
}
...
setmetatable(menu_tables, {
   __index = function(_, key) if key == "theme_names" then return theme_names end end,
