...
local default_color = colors.text.default
local selected_color = colors.text.selected
...
local function get_text_dimensions(str, lang, size)
  ...
  if image_map[str] then
    return image_map[str][lang].width, image_map[str][lang].height
  end
...
return {
  ...
  button_activated_color = button_activated_color,
